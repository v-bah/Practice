...
class Users(Users_db.Model):
    ...
    name = Users_db.Column(Users_db.String(150), nullable=False)
    birth_date = Users_db.Column(Users_db.String(100), nullable=False)
    INN = Users_db.Column(Users_db.String(100), nullable=False)
    passport_num = Users_db.Column(Users_db.String(100), nullable=False)
    passport_place = Users_db.Column(Users_db.Text, nullable=False)
    passport_date = Users_db.Column(Users_db.String(100), nullable=False)
    passport_code = Users_db.Column(Users_db.String(100), nullable=False)
    address = Users_db.Column(Users_db.Text, nullable=False)
    bank_account = Users_db.Column(Users_db.String(100), nullable=False)
    bank_name = Users_db.Column(Users_db.String(50), nullable=False)
    bank_details = Users_db.Column(Users_db.Text, nullable=False)
    email = Users_db.Column(Users_db.String(100), nullable = False)
...
def contract():
    ...
    if request.method == 'POST':
        ...
        email = Users.email
        hdr_cells[0].text = "Подрядчик " + name + INN + bank_name + bank_details + email
